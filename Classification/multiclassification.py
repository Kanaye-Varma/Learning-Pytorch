...
def main(epochs, learning_rate, num_classes): 
    ...
    optimiser = torch.optim.SGD(myModel.parameters(), lr=learning_rate)
...
if __name__ == '__main__':
    try:
        ...
        print("Correct usage: python multiclassification.py [epochs] [learning_rate] [num_classes]")
        sys.exit()